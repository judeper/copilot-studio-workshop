...
This workshop is designed for mixed audiences:

- [Maker] You want to design and improve agent experiences.
- [IT Pro] You want to understand environments, controls, publishing, and governance.
- [Developer] You want to extend, structure, and operationalize agent solutions.

> **Note:** You do not need to be an expert in every role. The workshop is designed so mixed teams can learn together and compare perspectives.
...
- A supported work or school Microsoft 365 account
- Access to Microsoft Copilot Studio
- Access to the target Power Platform environment
- Dataverse availability for Day 2 activities
- SharePoint access for grounding exercises
- Teams access if your facilitator includes publish-to-Teams demonstrations
...
- Stay with the current lab callout from your facilitator.
- Ask questions early if your environment or access does not match the room.
- Compare notes with participants from other roles when a topic affects process, governance, or extensibility.
- Focus on observable outcomes in each module rather than trying to perfect every detail during the session.
