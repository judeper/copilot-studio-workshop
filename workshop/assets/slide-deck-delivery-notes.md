...
- **Explanation: four grader types.** Briefly describe all four grader types available in the evaluation surface so participants understand what each one measures before they configure their own:
