...
4. A prebuilt starter template is available at `workshop\assets\Operative07StarterTemplate.zip`. Offer it to participants who need help getting started or are falling behind.
