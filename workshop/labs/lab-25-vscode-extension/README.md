...
#### Prerequisites
1. [Developer] Complete **Lab 13 — Loan Processing Agent Setup** and **Lab 14 — Agent Instructions**.
...
3. [Developer] Confirm you can open **Loan Processing Agent** in Copilot Studio in the browser.
...
3. [Developer] Choose the workshop environment, select **Loan Processing Agent**, and pick a local workspace folder when prompted.
...
8. [Developer] Locate the `instructions:` block. If you do not see it immediately, use global search in VS Code for `Loan Processing Agent` or `instructions:`.
9. [Developer] Update the instructions with one small but visible improvement, such as adding `Always end loan officer-facing guidance with the next recommended lending action.` or refining the ambiguity rule to request one focused follow-up question.
...
15. [Developer] Switch back to the Copilot Studio browser tab and refresh **Loan Processing Agent**.
...
18. [Developer] Enter a loan officer-style prompt that should reflect your change, such as a request for applicant guidance or loan review preparation.
...
#### Validation
1. [Developer] The **Loan Processing Agent** opens successfully in the Copilot Studio extension workspace.
